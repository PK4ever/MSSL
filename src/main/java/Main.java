...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        String databaseUrl = "jdbc:mysql://us-cdbr-iron-east-03.cleardb.net/heroku_14c5e8e85909083?reconnect=true";


        ConnectionSource connectionSource = new JdbcConnectionSource(databaseUrl);

        ((JdbcConnectionSource) connectionSource).setUsername("bde9bb4fe6db48");
        ((JdbcConnectionSource) connectionSource).setPassword("e2af364c");
